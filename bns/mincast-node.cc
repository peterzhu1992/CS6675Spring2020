...
MincastNode::StartApplication ()    // Called at time specified by Start
{
    ...
    for (auto it : m_knownAddresses) {
        if (it != m_address) ns3::Simulator::Schedule (ns3::Seconds(p->GetValue()), &MincastNode::SendPingMessage, this, it);
    }
...
void 
MincastNode::UpdateBucket (ns3::Ipv4Address addr, nodeid_t nodeID)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::BroadcastBlock (Block& b)
{
...
void
MincastNode::SendBlock (ns3::Ipv4Address &outgoingAddress, Block& b, uint16_t height)
{
...
void 
MincastNode::HandleRead (ns3::Ptr<ns3::Socket> socket)
{
...
void 
MincastNode::HandlePingMessage(ns3::Ipv4Address &senderAddr, nodeid_t& senderID)
{
    NS_LOG_FUNCTION (this);
...
void 
MincastNode::HandlePongMessage(ns3::Ipv4Address &senderAddr, nodeid_t& senderID)
{
    NS_LOG_FUNCTION (this);
    UpdateBucket(senderAddr, senderID);
    return;
...
void 
MincastNode::HandleFindNodeMessage(ns3::Ipv4Address &senderAddr, nodeid_t& senderID, nodeid_t& targetID)
{
    NS_LOG_FUNCTION (this);
    UpdateBucket(senderAddr, senderID);
...
void
MincastNode::HandleNodesMessage(ns3::Ipv4Address &senderAddr, nodeid_t& senderID, nodeid_t& targetID, std::vector<bentry_t> &nodes)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::HandleChunkMessage(ns3::Ipv4Address &senderAddr, nodeid_t& senderID, MinChunk c, uint16_t height)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::HandleRequestMessage(ns3::Ipv4Address &senderAddr, nodeid_t& senderID, uint64_t blockID)
{
...
void
MincastNode::SendPingMessage(ns3::Ipv4Address &outgoingAddress)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::SendPongMessage(ns3::Ipv4Address &outgoingAddress)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::SendFindNodeMessage(ns3::Ipv4Address &outgoingAddress, nodeid_t& targetID)
{
    NS_LOG_FUNCTION (this);
...
void 
MincastNode::SendNodesMessage(ns3::Ipv4Address &outgoingAddress, nodeid_t& targetID, std::vector<bentry_t> &nodes)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::SendChunkMessage(ns3::Ipv4Address &outgoingAddress, MinChunk c, uint16_t height)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::SendRequestMessage(ns3::Ipv4Address &outgoingAddress, uint64_t blockID)
{
    NS_LOG_FUNCTION (this);
...
void
MincastNode::InitLookupNode (nodeid_t &targetID)
{
    NS_LOG_FUNCTION(this);
...
void 
MincastNode::LookupNode (nodeid_t &targetID, bool queryAll)
{
    NS_LOG_FUNCTION(this);
    ...
    if (nQueried < MincastNode::kadK)  return;
...
void
MincastNode::RequestMissingBlock(ns3::Ipv4Address& senderAddr, uint64_t blockID)
{ 
...
void
MincastNode::RefreshNode(ns3::Ipv4Address &oldAddress, nodeid_t oldID, ns3::Ipv4Address &newAddress, nodeid_t newID)
{
    NS_LOG_FUNCTION (this);
...
void 
MincastNode::RefreshTimeoutExpired (ns3::Ipv4Address &addr, nodeid_t nodeID)
{
    NS_LOG_FUNCTION(this);
...
void
MincastNode::MarkQueried (nodeid_t& targetID, nodeid_t& nodeID)
{
    if (m_nodeLookups.count(targetID) == 0) return; // Make sure we do not acidentally create new entries
...
bool
MincastNode::IsQueried (nodeid_t& targetID, nodeid_t& nodeID)
{
...
Block
MincastNode::Dechunkify (std::map<uint16_t, MinChunk> chunks)
{
...
void 
MincastNode::TerminateLookup(nodeid_t& targetID)
{
